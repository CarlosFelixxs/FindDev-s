        ...
        <div className={styles.contRedes}>
          ...
          <div className={styles.contImagens}>
            <div id='instagram-icon-home'>
              <a rel="noreferrer" target='_blank' className={styles.imgBanner} href="https://www.instagram.com/carloshfelix__/"><img src={Instagram} alt="Logo" /></a>
            </div>
            <div id='git-icon-home'>
              <a rel="noreferrer" target='_blank' className={styles.imgBanner} href="https://github.com/CarlosFelixxs/FindDev-s"><img src={Git} alt="Logo" /></a>
            </div>
            <div id='linkedin-icon-home'>
              <a rel="noreferrer" target='_blank' className={styles.imgBanner} href="https://www.linkedin.com/"><img src={Linkedin} alt="Logo" /></a>
            </div>
            <div id='discord-icon-home'>
              <a rel="noreferrer" target='_blank' className={styles.imgBanner} href="https://discord.gg/bwYbEbK7"><img src={Discord} alt="Logo" /></a>
            </div>
            <div id='facebook-icon-home'>
              <a rel="noreferrer" target='_blank' className={styles.imgBanner} href="https://www.facebook.com/"><img src={Facebook} alt="Logo" /></a>
            </div>
          </div>
        </div>
      </section>
