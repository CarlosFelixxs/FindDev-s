...
export default function PerfilDev() {
          ...
          <div className={styles.info}>
            ...
            <span className={styles.textInfo}>
              ...
              <div className={styles.titulo}>
                <textarea
                  maxLength={50}
                  placeholder={titulo === "" ? 'Conte um resumo de suas experiências' : biografia}
        ...
        <section className={styles.sectionBio}>
          <div className={styles.contBio}>
            ...
            <div className={styles.bio}>
              <textarea
                maxLength={1000}
                placeholder={biografia === "" ? 'Conte um pouco sobre você' : biografia}
                className={editavel ? styles.inputBioEnable : "input-bio-disable"}
                disabled={!editavel}
